...
/**
 * The spectrum gain exponential filter increase alpha coefficient
 */
const float FILTER_GAIN_INC = 0.99f;

/**
 * The spectrum gain exponential filter decrease alpha coefficient
 */
const float FILTER_GAIN_DEC = 0.001f;

/**
 * The mel output exponential filter increase alpha coefficient
 */
const float FILTER_MEL_INC = 0.99f;

/**
 * The mel output exponential filter decrease alpha coefficient
 */
const float FILTER_MEL_DEC = 0.3f;
